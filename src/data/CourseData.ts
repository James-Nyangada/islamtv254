...
const course_data: DataType[] = [
   {
      ...
      user_name: "Ustaadh Noordeen",
      title: "Branches of Tawheed",
      rating: 4.3,
      total_rating: 23,
      price: 54,
   ...
   },
   {
      ...
      user_name: " Ustaadh Nordeen",
      title: "Swallah(leagl aspects of prayer)",
      rating: 4.8,
      total_rating: 20,
      price: 60,
   ...
   },
   {
      ...
      user_thumb: userThumb_1,
      user_name: "Ustaadh  Noordeen",
      title: "Shrik(Worshpping other than one God.",
      rating: 4.3,
      total_rating: 23,
      price: 54,
      category: "Graphics Digital Writing Music",
