            ...
            <div className="row justify-content-center">
               ...
               <div className="col-lg-7 order-lg-1 align-self-center">
                  <div className="banner-inner text-center text-lg-left mt-5 mt-lg-0">
                     ...
                     <h1 className="b-animate-2 title">A better learning future for Islam Religion starts here</h1>
                     <Link className="ed-btn btn-base b-animate-3 btn-gap" href="/course">Start Learning</Link>
